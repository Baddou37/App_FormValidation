...
function passwordStrength(){
    ...
    else if(passwordLength > 9 && passwordVerification.number && passwordVerification.symbol) {
        addLines(3);
    }
    else if(passwordLength > 6 && (passwordVerification.number || passwordVerification.symbol)) {
        addLines(2);
    }
    else {
        addLines(1);
